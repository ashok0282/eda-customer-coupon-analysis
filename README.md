# eda-customer-coupon-analysis

## Exploratory Data Analysis project of Customer Behaviour for Accepting Different kinds of Coupons (Restaurents, bars, coffee houses, takeaway etc) while driving under different conditions that could influence the decision or accepting / rejecting.
...
A READMe file with a summary of findings
=======================================================================================
